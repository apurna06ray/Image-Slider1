...
JavaScript shifts images using translateX()

A counter (count) tracks the current image
...
Click Next or Preview to slide images

Click Back to navigate to another page
